 ...
 * maintain compatibility. We divy to do this as little as possible, but it does
...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="total_table">
		...
		<div class="cart_subtotal">
			<div><?php esc_html_e( 'Totaal artikelen', 'woocommerce' ); ?></div>
		...
		<?php elseif ( WC()->cart->needs_shipping() && 'yes' === get_option( 'woocommerce_enable_shipping_calc' ) ) : ?>
			...
			<div class="shipping">
				<div><?php esc_html_e( 'Verzending', 'woocommerce' ); ?></div>
		...
		<div class="order-total">
			<div><?php esc_html_e( 'Totaal', 'woocommerce' ); ?></div>
