...
<form class="form-with-animated-labels woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
			<p class="form-row" id="calc_shipping_city_field">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn btn-primary-outline"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button></p>
